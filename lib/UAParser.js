...
const mapper = {
  ...
  rgx(ua, arrays) {
    let i = 0; let j; let k; let p; let q; let matches; let
      match;
...
const regexes = {
  ...
  browser: [[
    ...
    // Chromium/Flock/RockMelt/Midori/Epiphany/Silk/Skyfire/
    // Bolt/Iron/Iridium/PhantomJS/Bowser/QupZilla/Falkon
  ], [NAME, VERSION], [
